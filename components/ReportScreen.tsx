      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-brand-dark p-6 rounded-lg print-bg-white print-border">
          <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-brand-blue">Doctor's Analysis</h3>
              {report && (
                 <span className={`px-2 py-1 text-xs font-bold rounded-full ${report.source === 'AI' ? 'bg-blue-500 text-white' : 'bg-gray-500 text-white'}`}>
